...
In chapter [Loading a page containing JavaScript](https://fullstackopen.com/en/part0/fundamentals_of_web_apps#loading-a-page-containing-java-script-revised) the chain of events caused by opening the [page](https://studies.cs.helsinki.fi/exampleapp/notes) is depicted as a sequence diagram
